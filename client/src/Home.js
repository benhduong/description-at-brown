      ...
      <Box mt="8%" mb={"10%"} textAlign={"center"}>
        <InputGroup>
          ...
          <Input
            ...
            width="70%"
            background="white"
            placeholder="What are good courses to take?"
        ...
        <Grid templateColumns={"10% 55% 25% 10%"} autoFlow="row dense">
          <Box gridColumn={2}>
            <ScaleFade initialScale={0.1} in={recOutput != ""}>
              <Collapse startingHeight={305} in={show} ref={collapseRef}>
              ...
              <Button
                ...
                mt="1rem"
                display={
                  recOutput != "" && classList.length > 1 ? "block" : "none"
                }
              >
                Show {show ? "Less" : "More"}
              </Button>
